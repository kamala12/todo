...
var ContactHdr = '<li data-role="list-divider">Your list</li>';
...
$('#msgboxprompt').text('Kindel, et kustutan selle ülesande?');
...
toastr.success('Contact record successfully saved.', 'To Do List');
...
toastr.success('Contact record NOT successfully saved.', 'To Do List');
});
};
...
toastr.success('Contact record updated.', 'To Do List');
// clear the edit page form fields
pgEditContactClear();
// show the records listing page.
$.mobile.changePage('#pgContact', {transition: pgtransition});
}).fail(function (err) {
toastr.error('Contact record not updated, please try again.', 'To Do List');
return;
});
};
...
toastr.success('Contact record deleted.', 'To Do List');
// show the page to display after a record is deleted, this case listing page
$.mobile.changePage('#pgContact', {transition: pgtransition});
}).fail(function (err) {
toastr.error('Contact record not deleted, please try again.', 'To Do List');
return;
});
};
